...
class DiffusionAntibodyDesign(nn.Module):
    ...
    def forward(self, batch):
        ...
        s_0 = batch['aa']
        print('res feat:', res_feat.shape)
        print('pair feat:', pair_feat.shape)
        print('v0 feat:', v_0.shape)
        print('s0 feat:', s_0.shape)
        print('p0 feat:', p_0.shape)
        print('mask generate:', mask_generate.shape)
        print(mask_generate[0])
        print('mask residue:', mask_res.shape)
        print(mask_res[0])
        assert False
