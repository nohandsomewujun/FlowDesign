...
from diffab.modules.common.geometry import reconstruct_backbone_fullbb
...
def main():
    ...
    for variant in data_variants:
        ...
        for batch in tqdm(loader, desc=variant['name'], dynamic_ncols=True):
            ...
            aa_new = traj_batch[0][1]   # 0: Last sampling step. 1: Amino acid.
            pos_atom_new, mask_atom_new = reconstruct_backbone_fullbb(
                pos_ctx = batch['pos_heavyatom'],
                pos_recons = traj_batch[0][0],
                aa = aa_new,
