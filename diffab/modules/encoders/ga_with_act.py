...
class GABlock(nn.Module):
    ...
    def __init__(self, node_feat_dim, pair_feat_dim, value_dim=32, query_key_dim=32, num_query_points=8,
        ...
        super().__init__()
        ### NOTE: xcliu add activation function 
        self.act = nn.SiLU()
    ...
    def forward(self, R, t, x, z, mask):
        ...
        x_updated = self.layer_norm_1(x + self.act(feat_all))
        x_updated = self.layer_norm_2(x_updated + self.act(self.mlp_transition(x_updated)))
        return x_updated
